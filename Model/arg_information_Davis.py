...
def parse_args():
    ...
    parse.add_argument('--EPOCH', default=400, type=int, help='EOPCH')   
    ...
    parse.add_argument('--accumulation_steps', default=8, type=int, help='accumulation_steps')
    ...
    parse.add_argument('--dataset', default='davis', type=str, help='dataset:davis/kiba')
    parse.add_argument('--dataset_path', default='/home/ntu/fal_CPA/CPA1/fusion/data_davis/', type=str,
                       help='dataset_path')
    parse.add_argument('--smile_maxlenKB', default=85, type=int, help='smile_maxlenKB')
    parse.add_argument('--proSeq_maxlenKB', default=1200, type=int, help='proSeq_maxlenKB')
    parse.add_argument('--valDV_num', default=300, type=int, help='valDV_num')
    parse.add_argument('--trainKB_num', default=24000, type=int, help='trainKB_num')
    parse.add_argument('--testKB_num', default=5010, type=int, help='testKB_num')
    ...
    parse.add_argument('--logspance_trans', default='True', type=str, help='Davis:True/Kiba:False')
