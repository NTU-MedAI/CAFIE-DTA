...
from arg_information_Davis import *
...
class Transformer(nn.Module):
    ...
    def forward(self, input_Drugs, input_Tars, smiles,protein):
        ...
        compound_attention_feature= COMPOUND_MCAT_DAVIS(smiles, len(smiles),smiles).cuda()
...
if __name__ == '__main__':
    ...
    smiles_Val = smiles[27551:30056]
    proteins_Val = proteins[27551:30056]
    Drugs_fold_Val = labeledDrugs_shuttle[27551:30056]
    Targets_fold_Val = labeledTargets_shuttle[27551:30056]
    affiMatrix_fold_Val = affiMatrix_shuttle[27551:30056]
    ...
    model_fromTrain1 = '/home/ntu/fal_CPA/CPA1/fusion/youhua/Davis_result_0725/model_youhua1.pth'
    model_fromTrain2 = '/home/ntu/fal_CPA/CPA1/fusion/youhua/Davis_result_0725/model_youhua2.pth'
    model_fromTrain3 = '/home/ntu/fal_CPA/CPA1/fusion/youhua/Davis_result_0725/model_youhua3.pth'
    model_fromTrain4 = '/home/ntu/fal_CPA/CPA1/fusion/youhua/Davis_result_0725/model_youhua4.pth'
    model_fromTrain5 = '/home/ntu/fal_CPA/CPA1/fusion/youhua/Davis_result_0725/model_youhua5.pth'
    ...
    for count in range(4):
        ...
        for epoch in trange(EPOCHS,colour="green",desc="EPOCH Times"):
            ...
            for train_batch_idx, (SeqDrug, SeqTar, real_affi, smiles,proteins) in enumerate(train_loader):
                ...
                train_loss.backward()
                # batch_size from 32 -> 256'/home/ntu/fal_CPA/CPA/MY_Module_Finallshell/fusion/youhua/CPAyouhua_1125/model_youhua2.pth'
